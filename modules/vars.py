...
BOT_TOKEN = environ.get("BOT_TOKEN", "8920997566:AAHIiKL0E4wdxcO49vpTM6kKkygIOKRPi7M")

OWNER = int(environ.get("OWNER", "1999123487"))
...
OWNER_ID = int(environ.get("OWNER_ID", "1999123487"))  # Use OWNER as fallback
